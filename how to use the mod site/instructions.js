...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // These gradients define the visual theme for each step.
    const sectionBackgrounds = {
        "step-1": "linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 50%, #cbd5e1 100%)", // Light theme for intro
        "step-2": "linear-gradient(135deg, #faf5ff 0%, #f3e8ff 30%, #e9d5ff 70%, #c084fc 100%)", // Purple
        "step-3": "linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 30%, #99f6e4 70%, #5eead4 100%)", // Teal
        "step-4": "linear-gradient(135deg, #fffbeb 0%, #fef3c7 30%, #fde68a 70%, #f59e0b 100%)", // Orange/Yellow
        "step-5": "linear-gradient(135deg, #eff6ff 0%, #dbeafe 30%, #bfdbfe 70%, #60a5fa 100%)", // Blue
        "step-6": "linear-gradient(135deg, #fff1f2 0%, #fecdd3 30%, #fda4af 70%, #f87171 100%)", // Red/Pink
        "step-7": "linear-gradient(135deg, #dcfce7 0%, #bbf7d0 30%, #86efac 70%, #22c55e 100%)", // Green
        "step-8": "linear-gradient(135deg, #e0f2fe 0%, #bae6fd 30%, #7dd3fc 70%, #0ea5e9 100%)", // Light Blue
        "step-9": "linear-gradient(135deg, #fee2e2 0%, #fecaca 30%, #fca5a5 70%, #ef4444 100%)", // Red
        "step-10": "linear-gradient(135deg, #ecfdf5 0%, #d1fae5 30%, #a7f3d0 70%, #34d399 100%)", // Mint Green
        "step-11": "linear-gradient(135deg, #fefce8 0%, #faf8d1 30%, #fce99f 70%, #fbbf24 100%)", // Gold
        "step-12": "linear-gradient(135deg, #1f2937 0%, #374151 30%, #6b7280 70%, #9ca3af 100%)" // Dark theme for final choice
    };
